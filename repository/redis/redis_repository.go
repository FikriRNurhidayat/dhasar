...
import (
	...
	redis_database_manager "github.com/fikrirnurhidayat/dhasar/manager/database/redis"
	dhasar_repository "github.com/fikrirnurhidayat/dhasar/repository"
...
type RedisRepository[Entity any, Specification any, EntityJSON any, FallbackRepository dhasar_repository.Repository[Entity, Specification]] struct {
	Resource           string
	RDBM               redis_database_manager.RedisDatabaseManager
...
func (r *RedisRepository[Entity, Specification, EntityJSON, FallbackRepository]) Each(ctx context.Context, args dhasar_repository.ListArgs[Specification]) (dhasar_repository.Iterator[Entity], error) {
...
func (r *RedisRepository[Entity, Specification, EntityJSON, FallbackRepository]) List(ctx context.Context, args dhasar_repository.ListArgs[Specification]) ([]Entity, error) {
...
type Option[Entity any, Specification any, EntityJSON any, FallbackRepository dhasar_repository.Repository[Entity, Specification]] struct {
	Resource             string
	RedisDatabaseManager redis_database_manager.RedisDatabaseManager
	Logger               logger.Logger
	FallbackRepository   FallbackRepository
	Decode               Decoder[Entity, EntityJSON]
	Encode               Encoder[Entity, EntityJSON]
...
func New[Entity any, Specification any, EntityJSON any, FallbackRepository dhasar_repository.Repository[Entity, Specification]](opt Option[Entity, Specification, EntityJSON, FallbackRepository]) dhasar_repository.Repository[Entity, Specification] {
