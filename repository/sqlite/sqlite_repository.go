...
func (r *SQLiteRepository[Entity, Specification, Row]) Each(ctx context.Context, args dhasar_repository.ListArgs[Specification]) (dhasar_repository.Iterator[Entity], error) {
...
func (r *SQLiteRepository[Entity, Specification, Row]) List(ctx context.Context, args dhasar_repository.ListArgs[Specification]) ([]Entity, error) {
	rows, err := r.query(ctx, args)
	if err != nil {
...
func (r *SQLiteRepository[Entity, Specification, Row]) query(ctx context.Context, args dhasar_repository.ListArgs[Specification]) (*sql.Rows, error) {
	builder := sq.
		Select(r.columns...).
		From(r.tableName).
